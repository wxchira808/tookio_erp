...
def sync_tookio_nav_footer():
    ...
    top_bar_items = [
        ...
        {"label": "Services", "url": "/services", "right": 1},
        {"label": "Pricing", "url": "/pricing", "right": 1},
        {"label": "ARC System", "url": "/arc-system", "right": 1},
        {"label": "Automation Hub", "url": "/automation-hub", "right": 1},
        {"label": "Case Studies", "url": "/case-studies", "right": 1},
        {"label": "For Enterprises", "url": "/for-enterprises", "right": 1},
    ...
    footer_items = [
        ...
        {"label": "ERPNext Solutions", "parent_label": "Services", "url": "/services", "right": 0},
        ...
        {"label": "Custom Development", "parent_label": "Services", "url": "/services", "right": 0},
        ...
        {"label": "Automation Hub", "parent_label": "Resources", "url": "/automation-hub", "right": 0},
